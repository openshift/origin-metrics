...
setupCertificate "hawkular-metrics" "hawkular-metrics,${hawkular_metrics_hostname}" "HAWKULAR_METRICS_PEM"
setupCertificate "hawkular-cassandra" "hawkular-cassandra" "HAWKULAR_CASSANDRA_PEM"
